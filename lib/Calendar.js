  ...
  _createClass(Calendar, [{
    ...
    value: function renderDays(classes) {
      ...
      return days.map(function (data, index) {
        ...
        var isInRangeFirstOfRow = isStartOfWeek(dayMoment) && (isInRange || isEndEdge) || isStartEdge;
        var isInRangeLastOfRow = isEndOfWeek(dayMoment) && (isInRange || isStartEdge) || isEndEdge;
