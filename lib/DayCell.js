...
var DayCell = (function (_Component) {
  ...
  _createClass(DayCell, [{
    ...
    value: function getStateStyles() {
      ...
      var isInRangeFirstOfRow = _props.isInRangeFirstOfRow;
      var isInRangeLastOfRow = _props.isInRangeLastOfRow;
      ...
      var inRangeFirstOfRowStyle = isInRangeFirstOfRow ? styles['DayInRangeFirstOfRow'] : {};
      var inRangeLastOfRowStyle = isInRangeLastOfRow ? styles['DayInRangeLastOfRow'] : {};
      var isVisibleStyle = isVisible ? {} : { opacity: 0 };

      return _extends({}, todayStyle, inRangeStyle, hoverStyle, passiveStyle, activeStyle, selectedStyle, startEdgeStyle, endEdgeStyle, inRangeLastOfRowStyle, inRangeFirstOfRowStyle, isVisibleStyle);
    }
  }, {
    key: 'getClassNames',
    value: function getClassNames(classes) {
      ...
      var isInRangeFirstOfRow = _props2.isInRangeFirstOfRow;
      var isInRangeLastOfRow = _props2.isInRangeLastOfRow;

      return (0, _classnames3['default'])((_classnames = {}, _defineProperty(_classnames, classes.day, true), _defineProperty(_classnames, classes.dayActive, isSelected), _defineProperty(_classnames, classes.dayPassive, isPassive), _defineProperty(_classnames, classes.dayInRange, isInRange), _defineProperty(_classnames, classes.dayInRangeFirstOfRow, isInRangeFirstOfRow), _defineProperty(_classnames, classes.dayInRangeLastOfRow, isInRangeLastOfRow), _defineProperty(_classnames, classes.dayStartEdge, isStartEdge), _defineProperty(_classnames, classes.dayEndEdge, isEndEdge), _defineProperty(_classnames, classes.dayToday, isToday), _classnames));
    }
  }, {
    key: 'render',
...
DayCell.propTypes = {
  ...
  isInRangeFirstOfRow: _propTypes2['default'].bool,
  isInRangeLastOfRow: _propTypes2['default'].bool,
